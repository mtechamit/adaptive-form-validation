# Adaptive Form Validation Demo

This repository demonstrates a **proposed HTML `validation` attribute** for input fields to enable declarative, standardized validation without relying on external JavaScript.
...
- Lightweight, no extra JS required
